...
export default function Login() {
  ...
  // Wire these to your real auth later (Firebase/Auth0/Supabase/etc.)
...
const handleEmailLogin = (e) => {
  ...
  if (role === "student") {
    ...
    navigate("/dashboard/agent/overview"); // take agent directly to overview
  }
};
      ...
      <div className="container lg-shell">
        ...
        >
          ...
          <ul className="lg-side__points">
            <li><FiCheckCircle /> Secure, verified listings</li>
            <li><FiCheckCircle /> Escrow & refund rules</li>
            <li><FiCheckCircle /> Messaging & e-sign</li>
          </ul>
          <div className="lg-side__note">
            New here? <Link to="/register" className="lg-link">Create an account</Link>
          </div>
        </aside>
        ...
        <main className="lg-main card">
          ...
          <div className="lg-oauth">
            <button type="button" className="lg-google" onClick={handleGoogleLogin}>
              <svg className="lg-google__g" viewBox="0 0 48 48" aria-hidden="true">
            ...
            <div className="lg-sep"><span>or</span></div>
          </div>
          ...
          <form className="lg-form" onSubmit={handleEmailLogin}>
            ...
            <label className="lg-field">
              ...
              <div className="lg-row lg-row--actions">
                ...
                <Link to="/forgot" className="lg-link">Forgot password?</Link>
              </div>
            </label>

            <button className="btn lg-submit" type="submit" disabled={!canSubmit}>
              Log in <FiArrowRight />
            </button>

            <div className="lg-alt">
              New to HomeBridge? <Link to="/register" className="lg-link">Create an account</Link>
            </div>
          </form>
        </main>
      </div>
